...
st.write("""
This application predicts the likelihood of a customer purchasing a tourism package based on his 
characteristics and interaction.
Enter the client data below to get a prediction.
""")
...
if st.button("Predict"):
    ...
    result = "likely to purchase" if pred == 1 else "unlikely to purchase"
